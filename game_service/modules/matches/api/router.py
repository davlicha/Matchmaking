...
service = MatchService(match_repo=repo, player_client=player_client_instance)
...
async def finish_match(match_id: str, dto: FinishMatchDTO, request: Request, svc: MatchService = Depends(get_match_service)):
